...
function App() {
  ...
  return (
    <div>
      <Header />
      <div className="app-content flex flex-wrap align-middle items-center">
        <div className="w-full sm:w-1/2 max-h-screen">
          {<img src={cover} className="bg-white rounded-full object-contain object-top content-center h-100" alt="ep-cover" />}
        </div>
        <div className="w-full sm:w-1/2 app-contours py-20 lg:py-32 max-h-screen content-center">
